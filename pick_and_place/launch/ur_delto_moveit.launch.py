...
def generate_launch_description():
    return LaunchDescription([
        ...
        # ),
        ExecuteProcess(
            cmd=['ros2', 'launch', 'ur_robot_driver', 'ur5.launch.py', 'robot_ip:=192.168.0.100', 'launch_rviz:=false'],
            output='screen'
        ),
        # ExecuteProcess(
        ...
        ExecuteProcess(
            cmd=['ros2', 'launch', 'ur_moveit_config', 'ur_moveit.launch.py', 'ur_type:=ur5'],
            output='screen'
        ),
